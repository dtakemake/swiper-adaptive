...
const swiperAdaptive = (selector, options, breakpoint = 0, direction = "down") => {
    ...
    if (breakpoint < 320)
        new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](selector, options);
    // Swiper instance
    ...
    const initSwiper = () => {
        ...
        if (direction === "down") {
            if (documentWidth > breakpoint && instance === undefined) {
                instance = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](selector, options);
            }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (swiperAdaptive);
...
ready(() => {
    (0,_src_index__WEBPACK_IMPORTED_MODULE_0__["default"])('.swiper', {
        slidesPerView: 1
    }, 575.98, 'up');
});
...
/******/ })()
;
//# sourceMappingURL=010-default.development.js.map